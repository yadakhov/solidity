...
{
	TupleType const& lhs = *dynamic_cast<TupleType const*>(type(_assignment.leftHandSide()).get());
	TupleType const& rhs = *dynamic_cast<TupleType const*>(type(_assignment.rightHandSide()).get());
